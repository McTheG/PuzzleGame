...
public class CodeGame extends AppCompatActivity implements SensorEventListener {
    ...
    public void onClick(View v) {
        ...
        switch (id) {
            case R.id.lock1_button:
                Toast.makeText(CodeGame.this,"You clicked on Lock 1", Toast.LENGTH_SHORT).show();
                selectedLock = 1;
                break;
            case R.id.lock2_button:
                Toast.makeText(CodeGame.this,"You clicked on Lock 2", Toast.LENGTH_SHORT).show();
                selectedLock = 2;
                break;
            case R.id.lock3_button:
                Toast.makeText(CodeGame.this,"You clicked on Lock 3", Toast.LENGTH_SHORT).show();
                selectedLock = 3;
                break;
            case R.id.resetButton:
                Toast.makeText(CodeGame.this,"You clicked on reset", Toast.LENGTH_SHORT).show();
                randomizer();
                break;
        }
    }
    ...
    public void onSensorChanged(SensorEvent event) {
        ...
        */
        ...
        {
            Toast.makeText(CodeGame.this,"You solved the puzzle!!!", Toast.LENGTH_SHORT).show();
